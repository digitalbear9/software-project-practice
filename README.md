本仓库是软件项目软件项目研发实践（3）课程的实验仓库，所属人为23级软件工程3班熊博忠121052023113

下面是项目导航与各个实验的提交时间凭证（因为后续对各个实验文档按照老师要求重新做了修订，导致主页里不能直接查看提交时间）

## 项目导航

实验1_安装相关软件：安装课程所需软件[EX1-Software-Installation](./EX1-Software-Installation/)

实验2_1_Kotlin基本语法及实验：[EX2_1-Kotlin-Basic-Syntax](./EX2_1-Kotlin-Basic-Syntax/)

实验2_2_构建Kotlin应用并使用Compose布局[EX2_2-Build-Kotlin-App-With-Compose](./EX2_2-Build-Kotlin-App-With-Compose/)

实验2_3_构建CameraX应用[EX2_3-CameraXApp](./EX2_3-CameraXApp/)

实验3_Notebook基础实践[EX3-Jupyter-Notebook-Practice](./EX3-Jupyter-Notebook-Practice/)

实验4_实现智能图像分类APP[EX4-TFLClassify-main](./EX4-TFLClassify-main/)

实验5_1_TensorFlow模型生成[EX5_1-TensorFlow-Model-Training](./EX5_1-TensorFlow-Model-Training/)

实验5_2_TensorFlow石头剪刀布手势模型生成[EX5_2-TensorFlow-RPS-Model-Generation](./EX5_2-TensorFlow-RPS-Model-Generation/)

期末大作业[EX_Final-Waste-Classification-App](./EX_Final-Waste-Classification-App/)
